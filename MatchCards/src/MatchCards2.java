...
JFrame frame = new JFrame("Naruto Match Cards");//Main game window
...
/* If two selected cards don't match, the timer waits 1.5 seconds before flipping them back */  
    ...
    void setupCards(){
        ...
        for (String cardName : cardList){
            ...
            Image cardImg = new ImageIcon(getClass().getResource("./img2/" + cardName + ".jpg")).getImage();
        ...
        Image cardBackImg = new ImageIcon(getClass().getResource("./img2/cardback.jpg")).getImage();
